...
import { ArrowUpRight, ChevronRight, MapPin, Maximize2, Mail, Phone, Download, FileText, PenTool, Move } from 'lucide-react';
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-end">
                ...
                <div className="flex flex-col space-y-6">
                  <button 
                    ...
                    className="group inline-flex items-center space-x-4 text-[10px] font-bold uppercase tracking-[0.4em] text-stone-900 text-left"
                  >
              ...
              >
                <div className="relative aspect-[16/10] overflow-hidden bg-stone-200">
                  ...
                  <div className="absolute inset-0 bg-stone-900/60 opacity-0 group-hover:opacity-100 transition-opacity duration-500 backdrop-blur-[2px] flex flex-col justify-center items-center p-12 text-center text-white">
                    ...
                    <p className="text-sm font-light leading-relaxed max-w-sm mb-8 opacity-80">{project.description.slice(0, 80)}...</p>
                    <Link to={`/project/${project.id}`} className="w-12 h-12 border border-white/20 rounded-full flex items-center justify-center hover:bg-white hover:text-stone-900 transition-all duration-300">
                ...
                <div className="mt-8 flex justify-between items-start">
                  ...
                  <div className="text-right">
                    <span className="block text-[10px] font-bold uppercase tracking-widest text-stone-400 mb-2">{project.area}</span>
                    <Link to={`/project/${project.id}`} className="text-xs uppercase tracking-widest font-bold hover:text-bronze transition-colors">
                      View Details
                    </Link>
                  </div>
                </div>
